...
class LDATAService:
    ...
    def _get_clean_error_msg(self, response_text: str) -> str:
        ...
        # Strip HTML tags
        msg = _RE_HTML_TAGS.sub('', response_text)
        # Collapse multiple spaces into one
        msg = _RE_WHITESPACE.sub(' ', msg).strip()
    ...
    def set_blink_led(self, breaker_id: str, enabled: bool) -> bool:
        """Enable or disable the blink-LED indicator on a breaker."""
        url = f"https://my.leviton.com/api/ResidentialBreakers/{breaker_id}"
        referer = f"https://my.leviton.com/home/residential-breakers/{breaker_id}/settings"
    ...
    def _apply_breaker_update(
        ...
        if "blinkLED" in raw:
            existing["blinkLED"] = raw["blinkLED"]
